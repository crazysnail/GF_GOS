...
public class LoginUICanvas : UIFormLogic
{

    public Image mFirstInfo;
    public Image mLoginInfo;
    public Image mFastInfo;
    ...
    public void OnLoginClick()
    {
        bool isFirst = true;
        if( isFirst ){
            mFirstInfo.gameObject.SetActive(true);
        }
        else{
            mLoginInfo.gameObject.SetActive(true);
        }
    }

    public void OnFastClick()
    {
        mFastInfo.gameObject.SetActive(true);
    }
